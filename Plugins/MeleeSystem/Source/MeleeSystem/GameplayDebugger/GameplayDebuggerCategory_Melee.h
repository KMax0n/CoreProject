...
class FGameplayDebuggerCategory_Melee : public FGameplayDebuggerCategory
{
public:
	// Sets default values for this actor's properties
	FGameplayDebuggerCategory_Melee(){}
	...
	MELEESYSTEM_API static TSharedRef<FGameplayDebuggerCategory> MakeInstance();
protected:
